#!/bin/bash
# DockUp Global Nightly Build Installer (Interactive CLI Branch)
# Installs dockup as a global command from the feature/interactive-cli branch
# Usage: curl -fsSL https://raw.githubusercontent.com/Moe1211/dockup/feature/interactive-cli/install-global-nightly.sh | bash
...
echo ""
echo -e "${GREEN}✅ DockUp Nightly Build installed successfully!${NC}"
echo ""
